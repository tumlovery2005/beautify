package com.application.beautify.ui.owner.promotion.adapter
 ...
 */
class OwnerPromotionAdapter(var list: ArrayList<Promotion>): RecyclerView.Adapter<PromotionHolder>() {
